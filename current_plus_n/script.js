...
// Verses to Remove Selector Element
const versesToRemoveSelect = document.getElementById("versesToRemoveSelect");
...
// ---------------------------------------------------------
// 🔐 LOCAL STORAGE KEYS
const STORAGE_KEY = "gitaAppState_current_plus_n";
...
function loadState() {
    ...
    try {
        ...
        versesToRemove_num = state.versesToRemove_num || 1;
        versesToRemoveSelect.value = versesToRemove_num;
...
function handleGenerateVerse() {
    ...
    for (let i = 0; i < versesToRemove_num; i++) {
...
//Hooking up Verses to Remove Selector
versesToRemoveSelect.addEventListener("change", (e) => {
    versesToRemove_num = e.target.value;
